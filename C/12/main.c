...
/* Print the linked list pointed to by head, using the format:
   value1 -> value2 -> value3 -> ... -> last_in_sll_value
 ...
 */
void test_count_in_sll(node_t *head, int target, int expected)
{
 ...
 */
void test_last_in_sll(node_t *head, int expected)
{
...
int main(void)
{
    printf("SYSC 2006 Lab 12 Test Harness\n\n");
